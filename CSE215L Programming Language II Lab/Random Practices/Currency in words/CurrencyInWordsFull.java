...
public class CurrencyInWordsFull {
	...
	public static String amountInWords(int amount) {
        ...
        arr.append(getdigit((amount / 1000000000) % 100, "Billion, "));
        arr.append(getdigit((amount / 10000000) % 100, "Crore, "));
        arr.append(getdigit(((amount / 100000) % 100), "Lakh, "));
