...
template<class VertexType>
bool GraphType<VertexType>::foundEdge(VertexType from, VertexType to) {
    int fromIndex = IndexIs(vertices, from);
    int toIndex = IndexIs(vertices, to);
...
template<class VertexType>
int GraphType<VertexType>::modifiedBFS(VertexType startVertex, VertexType endVertex) {
    QueType<VertexType> queue;
    QueType<VertexType> vertexQ;
    bool found = false;
    VertexType vertex, item;
